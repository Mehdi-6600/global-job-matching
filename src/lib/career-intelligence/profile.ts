 ...
 * Used by offline Career Risk, Roadmap, and Migration.
...
function tasksForFamily(
  ...
  const base: Record<RoleFamily, TaskExposure[]> = {
    software_engineering: [
      {
        id: "impl",
        label: "Feature implementation / coding",
        automation: 70,
        judgment: 40,
        interpersonal: 20,
        regulatory: 10,
    ...
    accounting_finance: [
      ...
      {
        id: "report",
        label: "Financial reporting packs",
        automation: 65,
        judgment: 50,
        interpersonal: 30,
        regulatory: 55,
      ...
      {
        id: "advise",
        label: "Client / stakeholder advisory",
        automation: 20,
        judgment: 85,
        interpersonal: 90,
        regulatory: 50,
      ...
      {
        id: "control",
        label: "Controls and exception handling",
        automation: 45,
        judgment: 75,
        interpersonal: 40,
        regulatory: 70,
    ...
    education: [
      {
        id: "lesson",
        label: "Lesson delivery / facilitation",
        automation: 25,
        judgment: 75,
        interpersonal: 90,
        regulatory: 40,
      ...
      {
        id: "admin",
        label: "Admin / attendance / reports",
        automation: 70,
        judgment: 25,
        interpersonal: 25,
        regulatory: 30,
      ...
      {
        id: "pastoral",
        label: "Pastoral / parent communication",
        automation: 15,
        judgment: 80,
        interpersonal: 95,
        regulatory: 45,
      ...
      {
        id: "diff",
        label: "Differentiation for learners",
        automation: 30,
        judgment: 85,
        interpersonal: 70,
        regulatory: 35,
    ...
    healthcare: [
      ...
      {
        id: "med",
        label: "Medication / protocol adherence",
        automation: 35,
        judgment: 70,
        interpersonal: 40,
        regulatory: 95,
    ...
    trades: [
      ...
      {
        id: "safety",
        label: "Safety and code compliance",
        automation: 20,
        judgment: 75,
        interpersonal: 30,
        regulatory: 90,
      ...
      {
        id: "quote",
        label: "Estimates and client communication",
        automation: 30,
        judgment: 60,
        interpersonal: 80,
        regulatory: 20,
...
export function buildCareerProfile(input: ProfileInput): CareerProfile {
  ...
  const technicalSkills = skills.filter(
    (s) =>
      /[a-zA-Z0-9+#]{2,}/.test(s) ||
      /sql|react|python|excel|figma|node|java|aws|azure|docker|bim|sap/i.test(s)
  );
  const softSkills = skills.filter((s) => !technicalSkills.includes(s));
  ...
  const missingSkills = growth.filter(
    (g) =>
      !skillNorm.some(
        (s) => norm(g).includes(s) || s.includes(norm(g).slice(0, 6))
      )
  );
  ...
  else if (skills.length > 0) completeness += 10;
  if (years != null) completeness += 15;
  ...
  return {
    ...
    technicalSkills,
    softSkills,
    tools: technicalSkills.slice(0, 12),
    country,
    location,
    locale,
    tasks,
