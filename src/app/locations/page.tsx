    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20 pb-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Jobs by location</h1>
          <p className="text-slate-400 text-sm max-w-xl mx-auto">
            These pages only appear when there is at least one active job matching
            that location in our database — no empty doorway pages.
          </p>
        </div>
