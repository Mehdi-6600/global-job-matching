    ...
    <main className="min-h-screen bg-[var(--page-bg)] py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="glass-card border-[var(--ios-blue)]/30 relative">
          ...
          <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Professional</h2>
          ...
          <ul className="space-y-3 mb-8">
            ...
            <li className="flex items-center gap-2 text-[var(--text-secondary)]"><Check className="w-4 h-4 text-[var(--ios-blue)]" /> Early access to new features</li>
          </ul>
