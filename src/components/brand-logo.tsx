...
export function BrandMark({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="gjm-blue" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#3B82F6" />
          <stop offset="100%" stopColor="#06B6D4" />
        </linearGradient>
        <linearGradient id="gjm-green" x1="0" y1="0" x2="1" y2="1">
      ...
      {/* Left head */}
      <circle cx="22" cy="14" r="5" fill="url(#gjm-blue)" />

      {/* Right head */}
      <circle cx="42" cy="14" r="5" fill="url(#gjm-green)" />
