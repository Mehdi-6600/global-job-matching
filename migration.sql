...
-- Additive Job fields for ingestion / freshness / occupation
...
CREATE UNIQUE INDEX IF NOT EXISTS "Job_externalId_unique" ON "Job"("externalId") WHERE "externalId" IS NOT NULL;
